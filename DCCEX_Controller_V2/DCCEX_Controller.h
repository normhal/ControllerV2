...
*/
  ...
  const uint8_t rowsPerNextionLocosPage = 5;         //Nextion's design
/*
  **********************************
  * Program Page
  **********************************
...
#define eeJoinMode    (eepromEnd - 88)
#define eeSSID        (eepromEnd - 87)      //4095 - (24) 87 = 4008  24 Max 24 characters //This overlaps the UNO's Route locations
#define eePWD         (eepromEnd - 63)      //4095 - (24) 63 = 4032  24 Max 24 characters
#define eeIPAddr      (eepromEnd - 39)      //4095 - (16) 39 = 4056  16 Max 16 characters xxx.xxx.xxx.xxx
#define eePort        (eepromEnd - 23)      //4095 - (2)  23 = 4072  2 Max - 1 uint16_t
#define eeLocoStopAll (eepromEnd - 21)      //4095 - (1)  21 = 4074
#define eeWiFiSeconds (eepromEnd - 20)    //4095 - (1)  20 = 4075
#define eeRNumEnabled (eepromEnd - 19)      //4095 - (1)  19 = 4076
#define eeAccDelay    (eepromEnd - 18)      //4095 - (1)  18 = 4077  Delay between Accessory Route Commands
#define eeWiFiEnabled (eepromEnd - 17)      //4095 - (1)  17 = 4078
