...
void throttlePage(uint8_t button)
{
  ...
  if(message.startsWith("GL"))          //Guest Loco
  {
    ...
    savedSlot = activeSlot;           //MAKE GLOBAL
    activeSlot = numLocoSlots;              //force active Slot to be the Guest Slot
