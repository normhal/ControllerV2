...
void locosPage(uint8_t button)
{
  ...
  switch(button)
  {
    ...
    case SelectButton:
    {
      ...
      {
        throttles[activeSlot]->setLoco(new Loco(rosterList[selectedLocoID], LocoSource::LocoSourceRoster));
      }
...
//    Serial.printf("eeUseExRoster is %d\n\r", readEEPROMByte(eeUseExRoster));
