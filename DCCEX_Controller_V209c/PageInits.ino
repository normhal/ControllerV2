...
//      nextionSetText("FName", longLocoNames[selectedIDs[thNum][editingID]]);
      nextionSetText("FName", longLocoNames[editingID]);
    ...
    case ProgramPage:
    {
      ...
      nextionSetText("AD", String(readLocoAddress(selectedIDs[thNum][activeSlot[thNum]])));
      nextionSetText("LName", String(longLocoNames[selectedIDs[thNum][activeSlot[thNum]]]));
      nextionSetText("CVN", "");
      nextionSetText("CVV", "");
    ...
    case ConfigPage:                                                                                //Done
    {
      ...
      if(readEEPROMByte(eeUseExRoster)==1) nextionCommand("EX.pic=133");
      else nextionCommand("EX.pic=132");
