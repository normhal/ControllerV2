 ...
 *  First look for any action common to all Pages and only relevant to Nextion Navigation
...
void stopButton()
{
  if (readEEPROMByte(eeLocoStopAll) == 1)
  {
    ...
    throttles[activeSlot[thNum]]->setSpeed(0);
  }
}
/*
 *************************************************************************************************************************
...
void goButton()
{
  if (readEEPROMByte(eeLocoStopAll) == 1)
  {
    ...
    throttles[activeSlot[thNum]]->setSpeed(resumeSpeeds[activeSlot[thNum]]);
  }
}
/*
 *************************************************************************************************************************
...
void menuPage(uint8_t button)
{
  ...
  {
    Console.println("Saving Favs");
    saveSelected();
    return;
  }
  if (button == RestoreButton)
  {
    Console.println("Restoring Favs");
    restoreSelected();
    return;
  }
