...
************************************************************************/
  ...
  #define Version "V2.0.9c"
  uint8_t EEPROMCODE = 34;
...
/*
 * Values Common to all processor variants
*/
...
/*
  ********************************************************************************************************
  * EEPROM Names, Addresses and Memory Map for ESP32, ESP8266 and PICO
  * 
...
const uint16_t locoFuncBase  = locoAddrBase + (numLocos * addrLen);             //Funcs start at 1000 + (50 * 2) = 1100      //
...
const uint16_t routeStateBase = routeListBase + (numRoutes*routeLen/2);         //RStat start at 3348 + (48 * 12/2)(288) = 3636    //Divided by 2 because routeLen includes ID and State
const uint16_t configBase    = routeStateBase + (numRoutes*routeLen/2);         //CBase start at 3696 + (48 * 12/2)(288) = 3924 
...
#define eeUseExRoster (eepromEnd - 122)     //3974 - (1)  123 = 3973
#define eeActiveSlotA (eepromEnd - 121)     //3975 - (1)  122 = 3974
#define eeActiveSlotB (eepromEnd - 120)     //3976 - (1)  121 = 3975
#define eeActiveSlotC (eepromEnd - 119)     //3977 - (1)  120 = 3976
#define eeActiveSlotD (eepromEnd - 118)     //3978 - (1)  119 = 3977
#define eeSelIDsA     (eepromEnd - 117)     //3988 - (10) 118 = 3978  10 Selected IDs
#define eeSelIDsB     (eepromEnd - 107)     //3998 - (10) 108 = 3988  10 Selected IDs
#define eeSelIDsC     (eepromEnd - 97)      //4008 - (10) 98 = 3998  10 Selected IDs
#define eeSelIDsD     (eepromEnd - 87)      //4018 - (10) 88 = 4008  10 Selected IDs
#define eeJoinMode    (eepromEnd - 77)      //4019 - (1)  78 = 4018
#define eeSSID        (eepromEnd - 76)      //4043 - (24) 77 = 4019  24 Max 24 characters //This overlaps the UNO's Route locations
#define eePWD         (eepromEnd - 52)      //4067 - (24) 53 = 4043  24 Max 24 characters
#define eeIPAddr      (eepromEnd - 28)      //4083 - (16) 29 = 4067  16 Max 16 characters xxx.xxx.xxx.xxx
#define eePort        (eepromEnd - 12)      //4085 - (2)  13 = 4083  2 Max - 1 uint16_t
#define eeLocoStopAll (eepromEnd - 10)      //4086 - (1)  11 = 4085
#define eeWiFiSeconds (eepromEnd - 9)      //4087 - (1)  10 = 4086
#define eeRNumEnabled (eepromEnd - 8)      //4088 - (1)   9 = 4087
#define eeAccDelay    (eepromEnd - 7)      //4089 - (1)   8 = 4088  Delay between Accessory Route Commands
#define eeWiFiEnabled (eepromEnd - 6)      //4090 - (1)   7 = 4089
#define eeThreshold   (eepromEnd - 5)       //4091 - (1)  6  = 4090
#define eeREIncrement (eepromEnd - 4)       //4092 - (1)  5  = 4091
#define eePUState     (eepromEnd - 3)       //4093 - (1)  4  = 4092
#define eeDCCRefresh  (eepromEnd - 2)       //4094 - (1)  3  = 4093
...
//  const uint16_t DARK_GREY = 25388;
  ...
  */
  ...
  uint8_t oldSpeed = 0;
  uint8_t reading = 0;
  uint8_t old_pos = 0;  //rotaryEncoderPos;
