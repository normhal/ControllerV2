...
//  updateNextionThrottle(rotaryEncoderPos);
}
/*
 *********************************************************
...
*/
  ...
  {
  String dccppCMD = "";
  dccppCMD = ("<f " + String(readLocoAddress((selectedIDs[thNum][activeSlot[thNum]]))) +
                    " " + String(LocoFN0to4[selectedIDs[thNum][activeSlot[thNum]]]) + ">");
  sendCMD(dccppCMD);
}
void doDCCfunction58() 
{
  String dccppCMD = "";
  dccppCMD = ("<f " + String(readLocoAddress((selectedIDs[thNum][activeSlot[thNum]]))) +
                    " " + String(LocoFN5to8[selectedIDs[thNum][activeSlot[thNum]]]) + ">");
  sendCMD(dccppCMD);
}
void doDCCfunction912()          
{
  String dccppCMD = "";
  dccppCMD = ("<f " + String(readLocoAddress((selectedIDs[thNum][activeSlot[thNum]]))) +
                    " " + String(LocoFN9to12[selectedIDs[thNum][activeSlot[thNum]]]) + ">");
  sendCMD(dccppCMD);
}
void doDCCfunction1320()         
{
  String dccppCMD = "";
  dccppCMD = ("<f " + String(readLocoAddress((selectedIDs[thNum][activeSlot[thNum]]))) + " " + String(fGroup4) +
                    " " + String(LocoFN13to20[selectedIDs[thNum][activeSlot[thNum]]]) + ">");
  sendCMD(dccppCMD);
}
void doDCCfunction2128()         
{
  String dccppCMD = "";
  dccppCMD = ("<f " + String(readLocoAddress((selectedIDs[thNum][activeSlot[thNum]]))) + " " + String(fGroup5)+
                    " " + String(LocoFN21to28[selectedIDs[thNum][activeSlot[thNum]]]) + ">");
  sendCMD(dccppCMD);
}
#endif
...
/*  {
    ...
    dccppCMD = ("<F " + String(readLocoAddress((selectedIDs[thNum][activeSlot[thNum]]))) +
              " " + String(fNum) + 
              " " + String(functions[selectedIDs[thNum][activeSlot[thNum]]][g_fSlot]) + ">");
    sendCMD(dccppCMD);
  }
*/
#endif
...
//          nextionCommand("P2.pic=" + String(csImage).c_str());
          if(nextionPage == UpdatePage)
          {
