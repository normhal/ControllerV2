...
************************************************************************/
  ...
  #define USER1 0         //value for BLACK
  #define USER2 65535     //value for WHITE
  #define USER3 50712     //value for Nextion's background Grey
  #define USER4 65504     //value for YELLOW

  #define ENABLE_OTA

  #define USE_EX_ROSTER OFF
